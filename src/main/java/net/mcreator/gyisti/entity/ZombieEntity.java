...
import net.mcreator.gyisti.item.ImSorryItem;
...
public class ZombieEntity extends GyistiModElements.ModElement {
	public static EntityType entity = null;
	public ZombieEntity(GyistiModElements instance) {
		super(instance, 15);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("zombie")
						.setRegistryName("zombie");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(GyistiLivingItemGroup.tab)).setRegistryName("zombie"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			biome.getSpawns(EntityClassification.CREATURE).add(new Biome.SpawnListEntry(entity, 20, 2, 50));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("gyisti:textures/skin_zombie.png");
				}
			};
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("For Tester"));
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.CREEPER_HEAD, (int) (1)).getItem()), true));
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, MonsterSteveEntity.CustomEntity.class, true, false));
			...
			this.goalSelector.addGoal(15, new MeleeAttackGoal(this, 1.2, true));
			this.goalSelector.addGoal(16, new RandomWalkingGoal(this, 1));
			this.targetSelector.addGoal(17, new HurtByTargetGoal(this).setCallsForHelp(this.getClass()));
			this.goalSelector.addGoal(18, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(19, new SwimGoal(this));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ImSorryItem.block, (int) (1)));
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(ParticleTypes.NOTE, d0, d1, d2, d3, d4, d5);
				}
		}
	}
