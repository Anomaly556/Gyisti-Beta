...
import net.mcreator.gyisti.procedures.MonsterStevePlayerCollidesWithThisEntityProcedure;
import net.mcreator.gyisti.procedures.MonsterSteveEntityIsHurtProcedure;
...
public class MonsterSteveEntity extends GyistiModElements.ModElement {
	public static EntityType entity = null;
	public MonsterSteveEntity(GyistiModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("monster_steve").setRegistryName("monster_steve");
		elements.entities.add(() -> entity);
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(GyistiLivingItemGroup.tab)).setRegistryName("monster_steve"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (!biomeCriteria)
				continue;
			biome.getSpawns(EntityClassification.MONSTER).add(new Biome.SpawnListEntry(entity, 20, 2, 32));
		}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("gyisti:textures/steve_texture_je4_be2.png");
				}
			};
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(Blocks.TNT, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(Blocks.LAVA, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(Items.COOKED_BEEF, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(Items.ELYTRA, (int) (1)));
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new MoveTowardsVillageGoal(this, 0.5));
			...
			this.goalSelector.addGoal(6, new AvoidEntityGoal(this, MobEntity.class, (float) 6, 1, 1.2));
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, CreatureEntity.class, false, false));
			this.goalSelector.addGoal(11, new WaterAvoidingRandomWalkingGoal(this, 0.8));
			...
			this.goalSelector.addGoal(20, new SwimGoal(this));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				MonsterSteveEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				MonsterStevePlayerCollidesWithThisEntityProcedure.executeProcedure($_dependencies);
			}
		}
