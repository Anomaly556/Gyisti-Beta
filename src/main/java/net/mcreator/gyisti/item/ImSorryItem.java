...
public class ImSorryItem extends GyistiModElements.ModElement {
	@ObjectHolder("gyisti:im_sorry")
	public static final Item block = null;
	public ImSorryItem(GyistiModElements instance) {
		super(instance, 15);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Im..s orr y... i.m..z.om.b.ie...h..e.r..."));
		}
	}
}
