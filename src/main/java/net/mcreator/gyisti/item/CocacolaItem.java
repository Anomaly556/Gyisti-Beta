...
public class CocacolaItem extends GyistiModElements.ModElement {
	@ObjectHolder("gyisti:cocacola")
	public static final Item block = null;
	public CocacolaItem(GyistiModElements instance) {
		super(instance, 13);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("drink it!"));
		}
	}
}
